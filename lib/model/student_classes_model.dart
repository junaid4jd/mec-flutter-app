...
//
//     final studentClassesModel = studentClassesModelFromJson(jsonString);

import 'dart:convert';

StudentClassesModel studentClassesModelFromJson(String str) => StudentClassesModel.fromJson(json.decode(str));

String studentClassesModelToJson(StudentClassesModel data) => json.encode(data.toJson());
...
class StudentClassesModel {
  ...
  factory StudentClassesModel.fromJson(Map<String, dynamic> json) => StudentClassesModel(
    classGrade: json["classGrade"] == null ? null : json["classGrade"],
    classCode: json["classCode"] == null ? null : json["classCode"],
    uid: json["uid"] == null ? null : json["uid"],
    studentEmail: json["studentEmail"] == null ? null : json["studentEmail"],
